...
import { App, Button, Descriptions, Input, Select, Space, Table, Tag, Timeline } from "antd";
...
export default function OrderDetailPage() {
  ...
  const lineColumns: ColumnsType<OrderItem> = [
    ...
    },
    {
      ...
      width: 88,
      render: (u: string, row) =>
        u === "bundle" && row.piecesPerBundle ? `bundle (${row.piecesPerBundle})` : u,
    },
  ...
  const showGenericStatus = !!order && !readOnlyAbandoned && statusOptions.length > 0;
